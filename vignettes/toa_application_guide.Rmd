...
# Install from GitHub (repository URL will be  updated upon manuscript acceptance)
# devtools::install_github("XXXXX/activityTOA") 

# Alternative method: Install from local source package
install.packages("activityTOA_1.0.tar.gz", repos = NULL, type = "source")
```
